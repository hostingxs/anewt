...
class AnewtFormControlButton extends AnewtFormControl
{
	...
	function __construct($name)
	{
		...
		$this->_seed(array(
			...
			/* Whether this button was pressed. render-name must be
	...
	/**
	 * Detects whether this button is pressed.
	 */
	function fill($values) {
		$this->set('pressed', array_key_exists($this->get('name'), $values));

		return parent::fill($values);
	}

	/**
	 * Returns whether this button was pressed. Note that \c render-name must be
	 * \c true for this to work.
	 */
	function is_pressed() {
...
/**
 * Image control form button.
 */
class AnewtFormControlButtonImage extends AnewtFormControlButton
{
	/**
